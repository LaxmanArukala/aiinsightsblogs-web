...
const WHY_US = [
  'Every article is researched and written by advanced AI models, delivering accurate and up-to-date insights at scale.',
  ...
  'Continuously updated by AI models as the AI landscape evolves — no stale articles gathering dust.',
  'All code examples are generated, tested, and explained line by line by AI models.',
      ...
      <Box sx={{ background: 'linear-gradient(135deg, #0f172a 0%, #0c4a6e 60%, #164e63 100%)', py: { xs: 10, md: 16 }, position: 'relative', overflow: 'hidden' }}>
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <Typography variant="h6" sx={{ color: 'rgba(255,255,255,0.75)', lineHeight: 1.8, maxWidth: 680, mx: 'auto' }}>
            {SITE_NAME} is a fully automated knowledge hub — every article is researched, written, and
            updated by AI models to give you accurate, in-depth coverage of modern AI systems.
          </Typography>
        </Container>
      </Box>
            ...
            <Grid container spacing={8} sx={{ alignItems: 'center' }}>
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <Typography variant="h3" sx={{ fontWeight: 800, mb: 3, lineHeight: 1.2 }}>
                  Deep-Dive AI Content, Generated by AI Models
                </Typography>
                <Typography variant="body1" color="text.secondary" sx={{ mb: 3, lineHeight: 1.9 }}>
                  ...
                  at the surface level. {SITE_NAME} is fully automated by AI models to go deeper and keep up with the pace.
                </Typography>
                <Typography variant="body1" color="text.secondary" sx={{ mb: 4, lineHeight: 1.9 }}>
                  Our AI models focus on three topics reshaping how software is built: <strong>AI Agents</strong>, <strong>Large Language
                  Models</strong>, and <strong>Generative AI</strong>. Every article is generated to give you something you can apply
        ...
        <Box sx={{ py: 10, background: 'linear-gradient(135deg, #0f172a 0%, #0c4a6e 100%)', textAlign: 'center' }}>
          <Container maxWidth="md">
            ...
            <Typography variant="h6" sx={{ color: 'rgba(255,255,255,0.7)', mb: 4 }}>
              Browse our full library of articles — all free, all practical, all generated by AI models.
            </Typography>
