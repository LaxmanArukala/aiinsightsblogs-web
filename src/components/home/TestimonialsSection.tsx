  ...
  return (
    <Box sx={{ py: 8 }}>
      <Container maxWidth="xl">
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 5, textAlign: 'center', maxWidth: 600, mx: 'auto', lineHeight: 1.7 }}>Join thousands of professionals who rely on AI Insights Hub for expert analysis.</Typography>
