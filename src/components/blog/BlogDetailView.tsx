...
import { Box, Container, Grid, Typography, Breadcrumbs, Link as MuiLink, Chip, Stack, Paper, Button, Divider, IconButton, Tooltip, Card, CardContent, CardActionArea } from '@mui/material';
...
export default function BlogDetailView({ blog, otherArticles, relatedBlogs }: BlogDetailViewProps) {
